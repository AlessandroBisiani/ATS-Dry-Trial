 ...
 * @author Student
 */
public class CreateStaffAccount extends javax.swing.JFrame implements ChangeListener{
    private Model model;
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {                                        
        try {
            ...
            String role = getSelectedButtonText(Staff_Role);
            model.addUser(un, pw, name, surname, role);
